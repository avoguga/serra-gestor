...
function insertTestData() {
  db.eventos.bulkCreate([{
    Title: "Conferência de Tecnologia",
    Mes: "Março",
    DescriptionPT: "Uma conferência sobre as últimas tendências tecnológicas.",
    ...
    Mes: "Abril",
    DescriptionPT: "Um workshop interativo sobre técnicas modernas de pintura.",
...
app.get("/api/agendas", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var allEvents, eventosMapeados;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return db.eventos.findAll();
        case 3:
          allEvents = _context.sent;
          eventosMapeados = allEvents.map(function (evento) {
            return {
              id: evento.id,
              Title: evento.Title,
        ...
        case 8:
          ...
          console.error("Erro ao buscar eventos:", _context.t0);
...
app.get("/api/agendas/:id", /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return db.eventos.findByPk(req.params.id);
        case 3:
        ...
        case 7:
          ...
          console.error("Erro ao buscar detalhes do evento:", _context2.t0);
